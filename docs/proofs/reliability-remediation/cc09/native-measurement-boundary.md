...
The Mastra expert confirms conceptual `persist` policy semantics, but explicitly does not establish installed-version configuration nesting or adapter initialization. Those remain source-verification work, not an implemented measurement.
