...
- A successful write means the DOM value equalled the request after a settle of at least 20 ms and two animation frames, capped at 50 ms. It does not prove application state. A revert after that window is outside the claim.
