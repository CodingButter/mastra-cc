...
- [x] Live suite green on real hardware, with the machine and session type recorded in the receipt. Evidence: [the live suite on real hardware](proofs/the-live-suite-on-real-hardware.md) — 32/32 both lanes, minibeast, Wayland.
