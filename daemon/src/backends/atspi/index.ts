...
import type { ActivateElementParams, AttestElementParams, Diagnostic, DiscoverElementsParams, EditElementParams, QueryElementsParams, ReadElementContentParams, RevealElementParams, SendKeyChordParams, SemanticElement, SetElementCaretParams, SetElementTextParams, TypeTextParams, ClearElementTextParams, CaptureElementParams, ClickElementParams, ObservableContent, SetElementValueParams, SubmitElementParams } from "@mastra-cc/protocol-types";
import type { ActivateElementResult, AttestElementResult, DiscoverElementsResult, EditElementResult, QueryElementsResult, ReadElementContentResult, RevealElementResult, SendKeyChordResult, SetElementCaretResult, SetElementTextResult, TypeTextResult, CaptureElementResult, ClickElementResult, ClearElementTextResult, SetElementValueResult, SubmitElementResult } from "../../results.js";
import {
  type Backend,
  type BackendChange,
