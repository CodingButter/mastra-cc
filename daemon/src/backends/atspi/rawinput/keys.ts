...
// SYM. The other three constants are deliberately absent: an unused enum member
// is an invitation, and the two that misbehave are the two a future reader would
// reach for first.
const SYNTH_SYM = 1;
