...
// Mastra CC protocol v1.7.0

export const PROTOCOL_VERSION = "1.7.0";
export const SCHEMA_DIGEST = "a94841324573860264c9364893c3495d63478c1857b4ebb709c0499b592fa66d";
...
export const RUNNING_STATES = ["observable","not-observable","cannot-tell"] as const;
...
export interface InstalledApplication {
  ...
  launchable: boolean;
  /** Whether this application is answering right now. Deliberately not an availabilityState: availability answers whether this session MAY do something, while this answers what the desktop IS doing, which no permission grants and no setting starts. Always present, because a silently absent field would be read as a no. */
