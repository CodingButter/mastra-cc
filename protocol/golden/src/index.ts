...
// Mastra CC protocol v1.11.0

export const PROTOCOL_VERSION = "1.11.0";
export const SCHEMA_DIGEST = "03d6c52cee9b526890a646343ecfbacf3ea92d07dbc92d6fde42e26431dd62a3";
...
export const KEY_CHORD_NAMES = ["Enter","Escape","Tab","Shift+Tab","Backspace","Delete","ArrowUp","ArrowDown","ArrowLeft","ArrowRight","Home","End","PageUp","PageDown","F2","Control+a","Control+c","Control+x","Control+v","Control+z","Control+s"] as const;
